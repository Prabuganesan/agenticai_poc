...
2. Create a new workflow containing a **Webhook** module and a **Discord** module, as shown below:
   ...
   <figure><img src=".././assets/screely-1691756705932.png" alt="Workflow example"><figcaption></figcaption></figure>

3. From the **Webhook** module, copy the webhook URL:

   <figure><img src=".././assets/image (46).png" alt="Webhook URL" width="563"><figcaption></figcaption></figure>
...
4. In the **Discord** module, configure it to pass the `message` from the webhook body as the message sent to the Discord channel:
   ...
   <figure><img src=".././assets/image (47).png" alt="Discord module setup" width="563"><figcaption></figcaption></figure>
...
6. Send a test POST request with the following JSON body:
   ...
   <figure><img src=".././assets/image (48).png" alt="Sending POST request" width="563"><figcaption></figcaption></figure>

7. If successful, you will see the message appear in your Discord channel:

   <figure><img src=".././assets/image (49).png" alt="Discord message" width="249"><figcaption></figcaption></figure>
...
4. Define the **Input Schema**:
   ...
   <figure><img src=".././assets/image (167).png" alt="Input schema example"><figcaption></figcaption></figure>
...
5. Click **Add** to save your custom tool.
   ...
   <figure><img src=".././assets/image (51).png" alt="Tool added confirmation" width="279"><figcaption></figcaption></figure>
...
2. Connect them as shown:
   ...
   <figure><img src=".././assets/screely-1691758990676.png" alt="Chatflow setup"><figcaption></figcaption></figure>
...
Then, request the agent to send this information to Discord:
   ...
   <figure><img src=".././assets/image (53).png" alt="Sending message via agent" width="563"><figcaption></figcaption></figure>

You should see the message appear in your Discord channel:

   <figure><img src=".././assets/image (54).png" alt="Final message in Discord"><figcaption></figcaption></figure>
