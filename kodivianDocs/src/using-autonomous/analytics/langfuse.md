...
With the native integration, you can use Autonomous to quickly create complex LLM applications in no-code and then use Langfuse to monitor and improve them.

The integration supports all use cases of Autonomous, including: interactively in the UI, API, and embeds.
