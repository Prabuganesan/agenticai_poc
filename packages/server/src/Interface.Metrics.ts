...
export interface IMetricsProvider {
    ...
    incrementCounter(counter: KODIVIAN_METRIC_COUNTERS, payload: any): void
    trackLLMUsage?(usage: LLMUsageMetrics): void
}

export enum KODIVIAN_COUNTER_STATUS {
    SUCCESS = 'success',
    FAILURE = 'failure'
}

export enum KODIVIAN_METRIC_COUNTERS {
    CHATFLOW_CREATED = 'chatflow_created',
    AGENTFLOW_CREATED = 'agentflow_created',
    ASSISTANT_CREATED = 'assistant_created',
    TOOL_CREATED = 'tool_created',
    VECTORSTORE_UPSERT = 'vectorstore_upsert',
