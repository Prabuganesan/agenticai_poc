...
const fetchList = async ({ name, nodeData, previousNodes, currentNode }) => {
    ...
    if (!credentialId && (nodeData.inputs?.credential || nodeData.inputs?.['AUTONOMOUS_CREDENTIAL_ID'])) {
        credentialId = nodeData.inputs.credential || nodeData.inputs?.['AUTONOMOUS_CREDENTIAL_ID']
    }
